...
const QWEN_SYSTEM =
  ...
  "والأمان (لا تثق بالكلينت أبداً). قواعد حاسمة للكود: كل أسماء المتغيرات والدوال لاتينية فقط " +
  "(لا عربية أو سيريلية إطلاقاً)، ولا تستخدم عوامل +=" +
  "أو -= أو *= أو /= أو ++ (غير موجودة في لواو).";
